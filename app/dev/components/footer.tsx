...
const Footer = () => {
  return (
    <footer className="border-t border-zinc-800/30 py-10 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-center sm:text-left">
            <Image
              height={24}
              width={40}
              className="brightness-0 invert opacity-70 mb-2 mx-auto sm:mx-0"
              src="/dmtn.svg"
              alt="DMTN"
            />
        ...
        <div className="mt-6 pt-6 border-t border-zinc-800/30 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <nav className="flex items-center gap-6 text-xs text-zinc-600">
            ...
            <a href="#metodologia" className="hover:text-zinc-400 transition-colors">
              Metodologia
            </a>
            <Link
