      ...
      <div className="bg-[#0F1629]">
        ...
        <section className="py-24">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <ScheduleButton location="case-infomercados" className="inline-flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold px-8 py-4 rounded-2xl transition-all shadow-lg shadow-indigo-500/25" />
          </div>
        </section>
        <Footer />
      </div>
